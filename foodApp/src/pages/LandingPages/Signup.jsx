            ...
            {success ? (
                ...
                <div className="form-group">
                    <label htmlFor="name">
                        ...
                        <FontAwesomeIcon icon={faTimes} className={validName || !pseudo ? "hide" : "invalid"}/>
                    </label>
                    <input
                        type="name"
                        id="name"
                        ...
                        required
                    />
                    <p id="uidnote" className={userFocus && pseudo && !validName ? "instructions" : "offscreen"}>
                ...
                <button
                    type="submit"
                    className={(!validName || !validPwd || !validMatch) ? "login-button disable" : "login-button"}
